...
</code></pre></div><p>See the <a href="https://sharpscript.net/docs/sharp-apps#registering-servicestack-plugins" target="_blank" rel="noopener noreferrer">plugins app.settings</a> for examples of how to load and configure <a href="/plugins.html">ServiceStack Plugins</a>.</p>__VP_STATIC_END__`,58),g=`{"title":"ServiceStack's .NET Core Utility Belt","description":"","frontmatter":{"slug":"dotnet-tool","title":"ServiceStack's .NET Core Utility Belt"},"headers":[{"level":3,"title":"Add/Update ServiceStack References","slug":"add-update-servicestack-references"},{"level":3,"title":"Integrate with Visual Studio","slug":"integrate-with-visual-studio"},{"level":3,"title":"Integrate with Rider","slug":"integrate-with-rider"},{"level":3,"title":"Create new Project Templates","slug":"create-new-project-templates"},{"level":3,"title":"Mix Features into existing ASP.NET Core Apps","slug":"mix-features-into-existing-asp-net-core-apps"},{"level":3,"title":"Lisp REPL","slug":"lisp-repl"},{"level":3,"title":"Annotated REPL Walk through","slug":"annotated-repl-walk-through"}],"relativePath":"dotnet-tool.md","lastUpdated":1634794933356}`,c={};function i(l){return(u,d)=>(n(),t("div",null,[r,e("p",null,[s(a(o))])]))}const k=Object.assign(c,{setup:i});export{g as __pageData,k as default};
